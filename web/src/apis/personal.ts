...
export const attention = (params: AttentionReq) => {
    return httpRequest.post('/api/user/attention', params);
}
//创建收藏夹
export const createFavorites = (params: SaveCreateFavoritesDataReq | createFavoritesReq) => {
    return httpRequest.post('/api/user/createFavorites', params);
}
//获取收藏夹
export const getFavoritesList = () => {
    return httpRequest.post<GetFavoritesListRes>('/api/user/getFavoritesList');
}
//删除收藏夹
export const deleteFavorites = (params: DeleteFavoritesReq) => {
    return httpRequest.post('/api/user/deleteFavorites', params);
}
//收藏视频
export const favoriteVideo = (params: FavoriteVideoReq) => {
    return httpRequest.post('/api/user/favoriteVideo', params);
}

//获取收藏夹在视频页面页面需要视频id
export const getFavoritesListByFavoriteVideo = (params: GetFavoritesListByFavoriteVideoReq) => {
    return httpRequest.post<getFavoritesListByFavoriteVideoRes>('/api/user/getFavoritesListByFavoriteVideo', params);
}
//获取收藏夹内的视频
export const getFavoriteVideoList = (params: GetFavoriteVideoListReq) => {
    return httpRequest.post<GetFavoriteVideoListRes>('/api/user/getFavoriteVideoList', params);
}

//获取历史记录
export const getRecordList = (params: GetRecordListReq) => {
    return httpRequest.post<GetRecordListRes>('/api/user/getRecordList', params);
}

//清空历史记录
export const clearRecord = () => {
    return httpRequest.post('/api/user/clearRecord');
}
//删除历史记录
export const deleteRecordByID = (params: DeleteRecordByIDReq) => {
    return httpRequest.post('/api/user/deleteRecordByID', params);
}
//获取消息通知
export const getNoticeList = (params: GetNoticeListReq) => {
    return httpRequest.post<GetNoticeListRes>('/api/user/getNoticeList', params);
}
//获取最近聊天列表
export const getChatList = () => {
    return httpRequest.post<GetChatListRes>('/api/user/getChatList');
}
//点击私信时触发的操作
export const personalLetter = (params: PersonalLetterReq) => {
    return httpRequest.post('/api/user/personalLetter', params);
}
//删除最近聊天记录
export const deleteChatItem = (params: DeleteChatItemReq) => {
    return httpRequest.post('/api/user/deleteChatItem', params);
}
//加载历史聊天记录
export const getChatHistoryMsg = (params: GetChatHistoryMsgReq) => {
    return httpRequest.post<GetChatHistoryMsgRes>('/api/user/getChatHistoryMsg', params);
}